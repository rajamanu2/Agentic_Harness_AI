...
import { ForgeOSMessage } from "@shared/proto/forgeos/ui"
import { Logger } from "@/shared/services/Logger"
import { getRequestRegistry, StreamingResponseHandler } from "../grpc-handler"
import { Controller } from "../index"

// Keep track of active partial message subscriptions (gRPC streams)
const activePartialMessageSubscriptions = new Set<StreamingResponseHandler<ForgeOSMessage>>()

// Keep track of callback-based subscriptions (for CLI and other non-gRPC consumers)
type PartialMessageCallback = (message: ForgeOSMessage) => void
...
export async function subscribeToPartialMessage(
	...
	responseStream: StreamingResponseHandler<ForgeOSMessage>,
	requestId?: string,
): Promise<void> {
 ...
 * @param partialMessage The ForgeOSMessage to send
 */
export async function sendPartialMessageEvent(partialMessage: ForgeOSMessage): Promise<void> {
