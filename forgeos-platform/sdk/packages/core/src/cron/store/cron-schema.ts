import type { SqliteDb } from "@forgeos/shared/db";

/**
 * Bootstrap the dedicated cron.db schema. Unlike @forgeos/shared's
 * `ensureSessionSchema`, this schema is fully owned by @forgeos/core
