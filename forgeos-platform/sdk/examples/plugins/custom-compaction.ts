 ...
 *
 * CLI usage:
 *   forgeos plugin install https://github.com/forgeos/forgeos/blob/main/sdk/examples/plugins/custom-compaction.ts --cwd .
 *   forgeos -i "Search the codebase for dispatcher usage, then summarize it"
 */

import type { AgentPlugin, Message, ToolResultContent } from "@forgeos/core";
import { estimateTokens as estimateTokensFromChars } from "@forgeos/shared";
