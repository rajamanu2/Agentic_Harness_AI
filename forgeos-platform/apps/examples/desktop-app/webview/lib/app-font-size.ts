export const APP_FONT_SIZE_STORAGE_KEY = "forgeos.code.font-size.v1";
export const APP_FONT_SIZE_CHANGE_EVENT = "forgeos-app-font-size-change";
...
export const APP_FONT_SIZE_BOOTSTRAP_SCRIPT = `(() => {
	...
	root.dataset.forgeosFontSize = String(fontSize);
})();`;
...
export function applyAppFontSize(fontSize: AppFontSize): AppFontSize {
	...
	document.documentElement.dataset.forgeosFontSize = String(fontSize);
