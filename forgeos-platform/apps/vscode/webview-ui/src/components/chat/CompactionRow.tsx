...
function parseCompactionInfo(text: string | undefined): ForgeOSCompactionInfo | undefined {
	if (!text) {
		return undefined
	}
	try {
		...
		if (parsed && typeof parsed === "object" && typeof parsed.status === "string") {
			return parsed as ForgeOSCompactionInfo
		}
	} catch {
...
function formatCompactionLabel(info: ForgeOSCompactionInfo): string {
 ...
 */
export const CompactionRow = ({ message }: { message: ForgeOSMessage }) => {
