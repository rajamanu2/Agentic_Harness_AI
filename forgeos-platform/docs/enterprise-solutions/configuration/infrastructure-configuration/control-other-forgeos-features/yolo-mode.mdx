...
YOLO Mode enables ForgeOS to operate with complete autonomy, auto-approving all actions without user confirmation. For Enterprise administrators, this page covers how to control access to YOLO Mode across your organization.
...
When YOLO Mode is enabled, ForgeOS automatically approves all operations including file changes, terminal commands, browser actions, and mode transitions. This provides maximum automation speed but removes all safety guardrails.
...
- Users can enable or disable YOLO Mode in their local ForgeOS settings
...
- Persists across ForgeOS restarts
...
- Join our [Discord](https://discord.gg/forgeos) for community discussion
