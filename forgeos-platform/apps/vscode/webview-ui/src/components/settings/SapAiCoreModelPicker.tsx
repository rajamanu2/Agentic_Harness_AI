import { SapAiCoreModelDeployment } from "@shared/proto/index.forgeos"
...
const SapAiCoreModelPicker: React.FC<SapAiCoreModelPickerProps> = ({
	...
	const categorizedModels = useMemo(() => {
		...
		// Models that are both deployed AND supported in ForgeOS
		...
		// Models that are supported in ForgeOS but NOT deployed
