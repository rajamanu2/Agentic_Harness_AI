import type { ToggleCursorRuleRequest } from "@shared/proto/forgeos/file"
 ...
 */
export async function toggleCursorRule(controller: Controller, request: ToggleCursorRuleRequest): Promise<ForgeOSRulesToggles> {
