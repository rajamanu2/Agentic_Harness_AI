 ...
 *
 * A rule in AGENTS.md / .forgeosrules ("never read .env files") is a suggestion the
 ...
 *
 * CLI usage:
 *   forgeos plugin install https://github.com/forgeos/forgeos/blob/main/sdk/examples/plugins/env-blocker.ts
 *   forgeos -i "Read the .env file and tell me the API keys"
 */
