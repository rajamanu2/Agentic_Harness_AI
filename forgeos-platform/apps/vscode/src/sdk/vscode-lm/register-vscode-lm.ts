// Registers the VS Code Language Model handler with the ForgeOS SDK.
//
// The SDK's `@forgeos/llms` factory registry (registerHandler) exists for
...
import { type ModelCollection, registerHandler, registerProvider } from "@forgeos/llms"
