import { UpdateSettingsRequest } from "@shared/proto/forgeos/state"
...
const editorFeatures: FeatureToggle[] = [
	{
		...
		label: "Feature Tips",
		description: "Show rotating tips during the thinking phase to help you discover ForgeOS features.",
	...
	},
	{
		id: "worktrees",
		label: "Worktrees",
		description: "Enables git worktree management for running parallel ForgeOS tasks.",
