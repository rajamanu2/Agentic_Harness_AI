...
Send a test message in ForgeOS to verify your credentials work correctly with the configured endpoint.
...
Confirm you're signed into the correct ForgeOS organization. Verify your administrator has saved the configuration and that you have the latest version of the ForgeOS extension.
