...
import { useForgeOSSignIn } from "@/context/ForgeOSAuthContext"
import { useExtensionState } from "@/context/ExtensionStateContext"
import ForgeOSLogoVariable from "../../assets/ForgeOSLogoVariable"

// export const AccountWelcomeView = () => (
// 	<div className="flex flex-col items-center pr-3 gap-2.5">
// 		<ForgeOSLogoWhite className="size-16 mb-4" />
export const AccountWelcomeView = () => {
	...
	return (
		<div className="flex flex-col items-center gap-2.5">
			<ForgeOSLogoVariable className="size-16 mb-4" environment={environment} />
			...
			<p className="text-(--vscode-descriptionForeground) text-xs text-center m-0">
				By continuing, you agree to the <VSCodeLink href="https://forgeos.bot/tos">Terms of Service</VSCodeLink> and{" "}
				<VSCodeLink href="https://forgeos.bot/privacy">Privacy Policy.</VSCodeLink>
			</p>
		</div>
	)
}
