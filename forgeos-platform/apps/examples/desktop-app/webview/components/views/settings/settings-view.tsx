 ...
 * light-mode primary (see the [data-forgeos-accent] blocks in globals.css);
			...
			<section className="max-w-344">
				...
				<div className="flex items-center justify-between gap-5 border-b py-4 max-[720px]:flex-col max-[720px]:items-stretch">
					<div className="flex flex-col gap-1">
						...
						<p className="text-sm text-muted-foreground">
							Pick the icon ForgeOS shows in the Dock.
						</p>
						{appIconError ? (
				...
				<div className="flex py-4 items-center justify-between gap-5 border-b max-[720px]:flex-col max-[720px]:items-stretch max-[720px]:py-4">
					<div className="flex flex-col gap-1">
						...
						<p className="text-sm text-muted-foreground">
							Automatically update the forgeos terminal command, which shares your
				...
				<div className="flex py-4 items-center justify-between gap-5 border-b max-[720px]:flex-col max-[720px]:items-stretch max-[720px]:py-4">
					<div className="flex flex-col gap-1">
						...
						<p className="text-sm text-muted-foreground">
							Enable error and usage reports to help improve ForgeOS.
						</p>
						{telemetryError ? (
							<p className="mt-2 text-xs text-destructive" role="alert">
				...
				<div className="flex py-4 items-center justify-between gap-5 border-b max-[720px]:flex-col max-[720px]:items-stretch max-[720px]:py-4">
					<div className="flex flex-col gap-1">
						...
						<p className="text-sm text-muted-foreground">
							Replay the first-run experience new users see when they open ForgeOS
							for the first time.
						</p>
					</div>
					<Button
