 ...
 *
 * CLI usage:
 *   forgeos plugin install https://github.com/forgeos/forgeos/blob/main/sdk/examples/plugins/telemetry.ts --cwd .
 *   forgeos -i "Roll a die a few times and tell me your best roll."
 */
