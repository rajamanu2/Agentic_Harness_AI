...
import { loadSqliteDb, nowIso, type SqliteDb } from "@forgeos/shared/db";
import { resolveDbDataDir } from "@forgeos/shared/storage";
...
export class SqliteTeamStore implements TeamStore {
	...
	private ensureSchema(db: SqliteDb): void {
		...
		// Session/schedule schemas use separate migration paths in @forgeos/shared.
		db.exec(`
