...
The ForgeOS SDK supports two models for multi-agent work: sub-agents (parent-child) and teams (peer-to-peer).
...
```bash
forgeos --team-name auth-sprint "Continue the auth refactor"
```
...
- `../forgeoscore/api.md` - Session config for teams
