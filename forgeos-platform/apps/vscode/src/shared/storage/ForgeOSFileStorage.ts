...
import { ForgeOSSyncStorage } from "./ForgeOSStorage"

export interface ForgeOSFileStorageOptions {
	/**
 ...
 */
export class ForgeOSFileStorage<T = any> extends ForgeOSSyncStorage<T> {
	protected name: string
	private data: Record<string, T>
	private readonly fsPath: string
	private readonly fileMode?: number

	constructor(filePath: string, name = "ForgeOSFileStorage", options?: ForgeOSFileStorageOptions) {
		super()
