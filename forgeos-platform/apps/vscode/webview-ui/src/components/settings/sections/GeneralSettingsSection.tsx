			...
			<Section>
				...
				<div className="mb-[5px]">
					...
					<p className="text-sm mt-[5px] text-description">
						Help improve ForgeOS by sending usage data and error reports. No code, prompts, or personal information are
						ever sent. See our{" "}
						<VSCodeLink
							className="text-inherit"
							href="https://docs.forgeos.bot/more-info/telemetry"
						...
						<VSCodeLink
							className="text-inherit"
							href="https://forgeos.bot/privacy"
							style={{ fontSize: "inherit", textDecoration: "underline" }}>
							privacy policy
						</VSCodeLink>{" "}
						for more details.
