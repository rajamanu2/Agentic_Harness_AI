...
const PRIMITIVES: PrimitiveConfig[] = [
	{
		...
		description: (
			<>
				Reusable instruction sets that ForgeOS loads on demand for specific tasks, without staying in context for unrelated
	...
	},
	{
		...
		description: (
			<>
				Connect ForgeOS to external APIs, local tools, and hosted services through{" "}
	...
	},
	{
		...
		description: (
			<>
				<VSCodeLink href="https://docs.forgeos.bot/sdk/plugins">Plugins</VSCodeLink> are extensions for capabilities more
...
// (see https://github.com/forgeos/forgeos/pull/12522). MCP servers and skills are unaffected.
