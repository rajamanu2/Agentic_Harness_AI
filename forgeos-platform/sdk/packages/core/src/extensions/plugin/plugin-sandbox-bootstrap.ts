...
// Keep this local mirror in sync with AgentExtensionCommandResult from @forgeos/shared.
...
(globalThis as Record<string, unknown>).__forgeosPluginHost = { emitEvent };
 ...
 */
(globalThis as Record<string, unknown>).__forgeosSessionEnv = {
...
async function initialize(args: {
	...
	const sessionEnv = (globalThis as Record<string, unknown>)
		.__forgeosSessionEnv as Record<string, unknown>;
	if (sessionEnv) {
