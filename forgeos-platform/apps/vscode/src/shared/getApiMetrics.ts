...
/**
 * Calculates API metrics from an array of ForgeOSMessages.
 *
 ...
 */
export function getApiMetrics(messages: ForgeOSMessage[]): ApiMetrics {
 ...
 */
export function getLastApiReqTotalTokens(messages: ForgeOSMessage[]): number {
