...
/**
 * Markdown frontmatter parser for `.forgeos/cron/*.md` automation specs.
 *
 * Lives in @forgeos/core because it depends on `yaml`. The spec types
 * themselves live in @forgeos/shared so other packages can consume them
