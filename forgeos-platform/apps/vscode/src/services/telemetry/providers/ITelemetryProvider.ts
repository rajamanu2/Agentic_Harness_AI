...
export interface ITelemetryProvider {
	 ...
	 */
	identifyUser(userInfo: ForgeOSAccountUserInfo, properties?: TelemetryProperties): void
	 ...
	 * @param name Metric name (e.g., "forgeos.tokens.input")
	 ...
	 * Providers that don't support metrics may implement this as a no-op.
	 * @param name Metric name (e.g., "forgeos.api.duration_seconds")
	 ...
	 * Providers that don't support metrics may implement this as a no-op.
	 * @param name Metric name (e.g., "forgeos.workspace.active_roots")
