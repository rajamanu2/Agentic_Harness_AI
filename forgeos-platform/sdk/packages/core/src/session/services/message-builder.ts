...
export const MESSAGE_BUILDER_LIMIT_ENV = {
	maxToolResultChars: "FORGEOS_MESSAGE_BUILDER_MAX_TOOL_RESULT_CHARS",
	maxTotalTextBytes: "FORGEOS_MESSAGE_BUILDER_MAX_TOTAL_TEXT_BYTES",
	minOutdatedRewriteBytes: "FORGEOS_MESSAGE_BUILDER_MIN_OUTDATED_REWRITE_BYTES",
} as const;
