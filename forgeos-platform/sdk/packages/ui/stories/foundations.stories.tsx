...
const meta: Meta = {
	...
	parameters: {
		docs: {
			description: {
				component:
					"ForgeOS-owned color palettes feed readable visual roles and the shadcn semantic compatibility contract. Use the toolbar to compare light and dark modes.",
			},
		},
	},
};
...
export const Overview = () => (
	<main className="mx-auto grid max-w-6xl gap-10 p-8">
		<header className="space-y-3">
			<p className="text-sm font-medium text-primary">@forgeos/ui</p>
			<h1 className="text-4xl font-semibold tracking-tight">
				ForgeOS visual foundations
			</h1>
			<p className="max-w-3xl text-base text-muted-foreground">
				Adjust ForgeOS-owned palettes and visual roles; shadcn semantic tokens
		...
		<section className="space-y-4">
			<div>
				<h2 className="text-xl font-semibold">ForgeOS-owned palettes</h2>
		...
		<section className="grid gap-6 md:grid-cols-2">
			...
			<div className="space-y-4 rounded-xl border bg-card p-6">
				...
				<input
					...
					placeholder="Ask ForgeOS something..."
				/>
			</div>
		</section>
	</main>
