...
const buildEnvVars = {
	...
	"process.env.FORGEOS_ROLLOUT_VARIANT": JSON.stringify(process.env.FORGEOS_ROLLOUT_VARIANT || ""),
}
...
if (process.env.FORGEOS_ENVIRONMENT) {
	buildEnvVars["process.env.FORGEOS_ENVIRONMENT"] = JSON.stringify(process.env.FORGEOS_ENVIRONMENT)
}
...
const standaloneConfig = {
	...baseConfig,
	entryPoints: ["src/standalone/forgeos-core.ts"],
	outfile: `${destDir}/forgeos-core.js`,
