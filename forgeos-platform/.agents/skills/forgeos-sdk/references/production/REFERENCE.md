...
Guidelines for deploying ForgeOS SDK agents in production environments.
...
For ForgeOSCore, check `finishReason`:
...
```typescript
import type { BasicLogger } from "@forgeos/sdk"
...
- `../forgeoscore/REFERENCE.md` - ForgeOSCore overview
