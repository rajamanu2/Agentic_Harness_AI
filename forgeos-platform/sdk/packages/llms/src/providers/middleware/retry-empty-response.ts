...
// backends (openrouter, forgeos, generic OpenAI-compatible endpoints) do the
// same. In ForgeOS's runtime an empty assistant turn is a hard failure ("Model
...
// incompatible with ForgeOS, which streams via `doStream` and runs its own tool
