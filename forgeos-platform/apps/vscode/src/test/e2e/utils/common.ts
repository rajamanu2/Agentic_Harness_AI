...
export const addSelectedCodeToForgeOSWebview = async (_page: Page) => {
	...
	const addToForgeOS = _page.getByText(/Add to ForgeOS/i)
	await addToForgeOS.waitFor({ state: "visible" })
