...
const HUB_HOST_ENV = "FORGEOS_HUB_HOST";
const HUB_PORT_ENV = "FORGEOS_HUB_PORT";
const HUB_PATHNAME_ENV = "FORGEOS_HUB_PATHNAME";

export const DEFAULT_HUB_HOST = "127.0.0.1";
export const DEFAULT_HUB_PORT = FORGEOS_HUB_PORT;
...
function fallbackHubPort(options: ResolveHubDefaultsOptions): number {
	return resolveForgeOSBuildEnv(options) === "development"
		? FORGEOS_HUB_DEV_PORT
		: DEFAULT_HUB_PORT;
}
