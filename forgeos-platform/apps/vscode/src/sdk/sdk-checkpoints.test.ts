...
const userTask = (text: string, ts: number): ForgeOSMessage => ({
	ts,
	type: "say",
	say: "task",
	text,
...
const userFeedback = (text: string, ts: number): ForgeOSMessage => ({
	ts,
	type: "say",
	say: "user_feedback",
	text,
...
const assistant = (text: string, ts: number): ForgeOSMessage => ({
	ts,
	type: "say",
	say: "text",
	text,
...
const followupAsk = (text: string, ts: number): ForgeOSMessage => ({
	ts,
	type: "ask",
	ask: "followup",
	text,
...
const checkpointRow = (runCount: number, ts: number, ref = "old-ref"): ForgeOSMessage => ({
	ts,
	type: "say",
