 ...
 *
 * Use cases:
 * - Global hooks directory: ~/Documents/ForgeOS/Hooks/
 * - Workspace hooks: /path/to/My Project/.forgeosrules/hooks/
 * - Multi-root workspaces: each root's .forgeosrules/hooks/
 *
 * Examples:
