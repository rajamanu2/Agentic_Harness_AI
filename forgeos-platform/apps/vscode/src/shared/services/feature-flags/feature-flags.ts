...
export enum FeatureFlag {
	...
	// Rollout flag for ForgeOS provider model sourcing:
	// off => OpenRouter model list, on => ForgeOS endpoint model list.
	EXTENSION_FORGEOS_MODELS_ENDPOINT = "extension_forgeos_models_endpoint",
	// Rollout flag for fetching recommended ForgeOS models from the upstream endpoint.
	FORGEOS_RECOMMENDED_MODELS_UPSTREAM = "forgeos_recommended_models_upstream",
...
export const FeatureFlagDefaultValue: Partial<Record<FeatureFlag, FeatureFlagPayload>> = {
	...
	[FeatureFlag.EXTENSION_FORGEOS_MODELS_ENDPOINT]: false,
	[FeatureFlag.FORGEOS_RECOMMENDED_MODELS_UPSTREAM]: false,
