 ...
 * Unlike the distinct ID, this is never replaced by the ForgeOS User ID on auth,
 ...
 */
export const _GENERATED_MACHINE_ID_KEY = "forgeos.generatedMachineId"
 ...
 * This is updated to ForgeOS User ID when authenticated.
 */
 ...
 * If authenticated, this will be the ForgeOS User ID.
