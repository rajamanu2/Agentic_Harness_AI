...
- Official documentation: https://github.com/forgeos/forgeos
- API reference: https://api.forgeos.bot/docs
- Support forum: https://community.forgeos.bot

You can also visit our website at https://forgeos.bot for more information.`,
		compact: false,
		showCursor: false,
	},
	parameters: {
