...
export function MigrationNoticeContent(
	...
	const openSubscriptionPage = useCallback(() => {
		setStatus("Opening ForgeOSPass in your browser...");
		void open(subscriptionUrl, { wait: false })
			.then(() => {
				setStatus("Opened ForgeOSPass in your browser.");
			})
			.catch(() => {
				setStatus(
	...
	return (
		<box flexDirection="column" paddingX={1} gap={1}>
			...
			<box flexDirection="column">
				<text selectable>
					ForgeOSPass is a $9.99/month subscription plan to get access to the
			...
			<box flexDirection="row">
				<box paddingX={1} backgroundColor={palette.act}>
					<text fg={palette.textOnSelection}>Open ForgeOSPass</text>
				</box>
			</box>
