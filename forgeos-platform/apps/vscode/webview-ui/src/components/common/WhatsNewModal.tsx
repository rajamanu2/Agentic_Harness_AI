import { BannerAction, BannerCardData } from "@shared/forgeos/banner"
					...
					<div className="flex flex-col items-center gap-3 mt-4 pt-4 border-t border-[var(--vscode-widget-border)]">
						...
						<div className="flex items-center gap-4">
							...
							<a
								...
								className="text-[var(--vscode-foreground)] hover:text-[var(--vscode-textLink-activeForeground)] transition-colors"
								href="https://github.com/forgeos/forgeos"
								rel="noopener noreferrer"
								target="_blank">
								<GitHubIcon />
							</a>
							...
							<a
								...
								className="text-[var(--vscode-foreground)] hover:text-[var(--vscode-textLink-activeForeground)] transition-colors"
								href="https://www.reddit.com/r/forgeos/"
								rel="noopener noreferrer"
								target="_blank">
								<RedditIcon />
							</a>
							...
							<a
								...
								className="text-[var(--vscode-foreground)] hover:text-[var(--vscode-textLink-activeForeground)] transition-colors"
								href="https://www.linkedin.com/company/forgeosbot/"
								rel="noopener noreferrer"
								target="_blank">
								<LinkedInIcon />
							</a>
