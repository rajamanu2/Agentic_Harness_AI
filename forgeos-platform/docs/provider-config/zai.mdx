---
title: "Z AI (Zhipu AI)"
description: "Learn how to configure and use Z AI's GLM models with ForgeOS. Experience advanced hybrid reasoning, agentic capabilities, and open-source excellence with regional optimization."
---
...
### Configuration in ForgeOS

> See [Authorization & Model Selection](/getting-started/authorizing-with-forgeos#menu).

1.  **Open ForgeOS Settings:** Click the settings icon (⚙️) in the ForgeOS panel.
...
To use the GLM Coding Plans with ForgeOS:
...
3. **Configure in ForgeOS:** Open ForgeOS settings, select "Z AI" as your provider, and paste your API key into the "Z AI API Key" field.

<Frame>
  <img src="https://storage.googleapis.com/forgeos_public_images/docs/assets/zAI-provider.png" alt="ForgeOS settings with zAI provider selected and API key field highlighted" />
</Frame>

The setup connects your subscription directly to ForgeOS, giving you access to GLM-4.5's tool-calling capabilities optimized for coding workflows.
