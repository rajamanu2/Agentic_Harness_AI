...
//   - buildSessionConfig() in forgeos-session-factory.ts (main task loop, which
//     hands a CoreSessionConfig.providerConfig to ForgeOSCore)
//
...
import type { ProviderSettings } from "@forgeos/core"
import type { ProviderConfig } from "@forgeos/llms"
