...
// ForgeOS Provider model schema with per-model settings
export const ForgeOSModelSchema = z.object({
	id: z.string(), // The model ID is required
});

// ForgeOS Provider specific settings
export const ForgeOSSettingsSchema = z.object({
	// A list of the allowed models with their settings
	models: z.array(ForgeOSModelSchema).optional(),
});
...
const ProviderSettingsSchema = z.object({
	...
	ForgeOS: ForgeOSSettingsSchema.optional(),
...
// Settings for a global forgeos rules or workflow file.
