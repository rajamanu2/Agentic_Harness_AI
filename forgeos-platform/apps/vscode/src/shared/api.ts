import type { ModelModalities, ModelOperation, ModelOperationMode } from "@forgeos/shared"
import { ApiFormat } from "./proto/forgeos/models"
...
export const forgeosPassDefaultModelId = "forgeos-pass/glm-5.2"
export const forgeosPassModelInfoSaneDefaults: ModelInfo = {
	maxTokens: 8_192,
...
export function resolveForgeOSPassModelInfo(modelId: string, modelInfoByName?: Record<string, ModelInfo>): ModelInfo {
	return modelInfoByName?.[getModelSlug(modelId)] ?? forgeosPassModelInfoSaneDefaults
}
...
//
// The Codex catalog and default model id are sourced from the `@forgeos/llms`
// SDK.
// Azure OpenAI
