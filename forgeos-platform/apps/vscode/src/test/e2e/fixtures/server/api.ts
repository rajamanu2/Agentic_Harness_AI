...
export const E2E_MOCK_EDITOR_TOOL_CALL = {
	...
	arguments: {
		...
		new_text: 'export const name = "forgeos"',
	},
}
...
const edit_request_complete = `I successfully replaced "john" with "forgeos" in the test.ts file. The change has been completed and the file now contains:

\`\`\`typescript
export const name = "forgeos"
\`\`\`

The change has been applied and saved to the file.`

export const E2E_MOCK_API_RESPONSES = {
	DEFAULT: "Hello! I'm a mock ForgeOS API response.",
	/** Assistant text streamed before the structured editor tool call. */
	EDIT_REQUEST_LEAD_IN: `I'll replace "john" with "forgeos" in the test.ts file.`,
...
export const E2E_MOCK_FORGEOS_RECOMMENDED_MODELS = {
	free: [
		{
			id: "z-ai/glm-5",
			name: "z-ai/glm-5",
...
export const E2E_MOCK_FORGEOS_MODELS = [
	{
		id: "z-ai/glm-5",
		name: "z-ai/glm-5",
		description: "Free model for e2e onboarding",
