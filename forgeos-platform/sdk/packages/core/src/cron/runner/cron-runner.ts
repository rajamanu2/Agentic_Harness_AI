...
import { nowIso } from "@forgeos/shared/db";
import type { ResolveCronSpecsDirOptions } from "@forgeos/shared/storage";
...
export interface CronRunnerOptions {
	...
	/** Cron spec source/report location. Defaults to global `~/.forgeos/cron`. */
...
export class CronRunner {
	...
	private async buildSystemPrompt(
		...
		const base = buildForgeOSSystemPrompt({
			ide: "ForgeOS Cron",
			workspaceRoot,
