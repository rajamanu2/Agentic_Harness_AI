...
// gRPC and ultimately reads from `@forgeos/llms`. Do not add a static
...
export function getModeSpecificFields(apiConfiguration: ApiConfiguration | undefined, mode: Mode) {
	if (!apiConfiguration) {
		return {
			...
			forgeosModelId: undefined,
			forgeosPassModelId: undefined,
	...
	const forgeosModelId = mode === "plan" ? apiConfiguration.planModeForgeOSModelId : apiConfiguration.actModeForgeOSModelId
	const forgeosModelInfo = mode === "plan" ? apiConfiguration.planModeForgeOSModelInfo : apiConfiguration.actModeForgeOSModelInfo
	const forgeosPassModelId =
		mode === "plan" ? apiConfiguration.planModeForgeOSPassModelId : apiConfiguration.actModeForgeOSPassModelId
	const forgeosPassModelInfo =
		mode === "plan" ? apiConfiguration.planModeForgeOSPassModelInfo : apiConfiguration.actModeForgeOSPassModelInfo
...
export async function syncModeConfigurations(
	...
	switch (apiProvider) {
		...
		case "forgeos":
			updates.planModeForgeOSModelId = sourceFields.forgeosModelId
			updates.actModeForgeOSModelId = sourceFields.forgeosModelId
			updates.planModeForgeOSModelInfo = sourceFields.forgeosModelInfo
			updates.actModeForgeOSModelInfo = sourceFields.forgeosModelInfo
			break

		case "forgeos-pass":
			updates.planModeForgeOSPassModelId = sourceFields.forgeosPassModelId
			updates.actModeForgeOSPassModelId = sourceFields.forgeosPassModelId
			updates.planModeForgeOSPassModelInfo = sourceFields.forgeosPassModelInfo
			updates.actModeForgeOSPassModelInfo = sourceFields.forgeosPassModelInfo
			break
