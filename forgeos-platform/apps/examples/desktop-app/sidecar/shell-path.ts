...
const PATH_MARKER_START = "__FORGEOS_SIDECAR_PATH_START__";
const PATH_MARKER_END = "__FORGEOS_SIDECAR_PATH_END__";
...
/**
 * Escape hatch: set FORGEOS_SIDECAR_SKIP_SHELL_PATH=1 to leave PATH untouched
 * (e.g. if a broken shell profile makes resolution misbehave).
 */
const SKIP_ENV_VAR = "FORGEOS_SIDECAR_SKIP_SHELL_PATH";
 ...
 * FORGEOS_SIDECAR_SKIP_SHELL_PATH is set. Failures are reported via the
