export const FeatureFlag = {
	/** Enables ForgeOSPass provider/model list exposure in supported clients. */
	FORGEOS_PASS: "ext-forgeos-pass",
} as const;
...
export interface FeatureFlagsContext {
	...
	distinctId?: string;
	/** Authenticated ForgeOS account/user ID, when available. */
	userId?: string | null;
...
> = {
	[FeatureFlag.FORGEOS_PASS]: false,
};
