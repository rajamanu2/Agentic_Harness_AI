...
# 
# Executes when the user submits a prompt to ForgeOS.
# 
# Input: { taskId, userPromptSubmit: { prompt: string, attachments: string[] }, forgeosVersion, timestamp, ... }
# Output: { cancel: boolean, contextModification?: string, errorMessage?: string }
# 
# Use cases:
...
# Notification Hook
#
# Executes when ForgeOS reaches a user-attention boundary or emits lifecycle notifications.
#
# Input: {
#   taskId,
#   notification: {
