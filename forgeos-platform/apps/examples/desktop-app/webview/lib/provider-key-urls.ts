...
const PROVIDER_API_KEY_URLS: Record<string, string> = {
	...
	forgeos: "https://app.forgeos.bot",
};

/** ForgeOS account dashboard, where ForgeOS API keys are created and managed. */
export const FORGEOS_DASHBOARD_URL = "https://app.forgeos.bot";
