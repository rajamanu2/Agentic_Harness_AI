...
description: "Use ForgeOS Kanban to run multiple coding agents in parallel with isolated git worktrees."
---
...
Kanban is designed for CLI-style coding agents and currently works with ForgeOS CLI, Claude Code, Codex, OpenCode, and related runtimes available in settings.
