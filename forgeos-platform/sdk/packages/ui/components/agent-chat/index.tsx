	...
	({ children, className, ...props }, ref) => {
		...
		return (
			<ConversationContext.Provider value={value}>
				<div
					className={classNames("forgeos-chat-conversation", className)}
					ref={ref}
					{...props}
				>
					{children}
	...
	(
		...
		return (
			<div
				...
				aria-live={ariaLive}
				className={classNames("forgeos-chat-conversation-viewport", className)}
				ref={ref}
				role="log"
				tabIndex={tabIndex}
			/>
...
>(({ className, ...props }, forwardedRef) => {
	...
	return (
		<div
			className={classNames("forgeos-chat-conversation-content", className)}
			ref={ref}
			{...props}
		/>
	);
...
export const ConversationEmptyState = ({
	...
	<div className={classNames("forgeos-chat-empty-state", className)} {...props}>
		{children ?? (
			<>
				{icon ? (
					<div className="forgeos-chat-empty-state-icon">{icon}</div>
				) : null}
				<div>
					<h3>{title}</h3>
...
export const ConversationScrollButton = ({
	...
	return (
		<button
			{...props}
			aria-label={ariaLabel}
			className={classNames("forgeos-chat-scroll-button", className)}
			onClick={(event) => {
				onClick?.(event);
...
export const Message = ({ className, from, ...props }: MessageProps) => (
	<div
		{...props}
		className={classNames("forgeos-chat-message", className)}
		data-role={from}
	/>
);
...
export const MessageContent = ({
	...
	<div
		className={classNames("forgeos-chat-message-content", className)}
		{...props}
	/>
);
...
export const MessageActions = ({
	...
	<div
		{...props}
		className={classNames("forgeos-chat-message-actions", className)}
		data-side={side}
...
export const MessageAction = ({
	...
	<IconButton
		...
		className={classNames("forgeos-chat-message-action", className)}
		variant="ghost"
		tone="neutral"
		size="xs"
	/>
...
export const Reasoning = ({
	...
	return (
		<ReasoningContext.Provider value={value}>
			<div
				{...props}
				className={classNames("forgeos-chat-reasoning", className)}
...
export const ReasoningTrigger = ({
	...
	return (
		<button
			...
			className={classNames("forgeos-chat-reasoning-trigger", className)}
			onClick={(event) => {
				onClick?.(event);
		...
		>
			{children ?? (
				<>
					...
					<ChevronDownIcon className="forgeos-chat-disclosure-icon" />
				</>
			)}
		</button>
	);
...
export const ReasoningContent = ({
	...
	return (
		<div
			{...props}
			className={classNames("forgeos-chat-reasoning-content", className)}
			id={panelId}
		/>
	);
};
...
export const ToolActivity = ({
	...
	return (
		<ToolActivityContext.Provider value={value}>
			<div
				{...props}
				className={classNames("forgeos-chat-tool", className)}
...
export const ToolActivityTrigger = ({
	...
	const content = children ?? (
		<>
			{inFlight ? (
				<output aria-label={status} className="forgeos-chat-tool-progress" />
			) : icon ? (
				<span className="forgeos-chat-tool-icon">{icon}</span>
			) : null}
			<span className="forgeos-chat-tool-label">{label}</span>
			{additions !== undefined || deletions !== undefined ? (
				<span className="forgeos-chat-tool-diff">
					{additions !== undefined ? (
	...
	const triggerClassName = classNames("forgeos-chat-tool-trigger", className);
...
export const ToolActivityContent = ({
	...
	return (
		<div
			{...props}
			className={classNames("forgeos-chat-tool-content", className)}
			id={panelId}
		/>
	);
};
...
export const ToolActivityDetails = ({
	...
	<div
		className={classNames("forgeos-chat-tool-details", className)}
		{...props}
	/>
);
...
export const ToolActivityCode = ({
	...
	<pre className={classNames("forgeos-chat-tool-code", className)} {...props} />
);
