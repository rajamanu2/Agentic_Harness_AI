...
function usage(): never {
	console.error(`Usage:
	  bun -F @forgeos/core test:compaction -- <session-directory> [options]
...
FORGEOS_API_KEY, OPENAI_API_KEY, GOOGLE_API_KEY, or MISTRAL_API_KEY, according
to --provider.`);
	process.exit(1);
}
