 ...
 * @forgeos/agents
 *
 * Browser-safe agent runtime for the next-generation ForgeOS SDK.
 *
 * Exports:
 ...
 *   - `createTool` — re-exported from `@forgeos/shared` for authoring tools.
 *
 * Shared types (`AgentMessage`, `AgentRunResult`, etc.) should be imported
 * directly from `@forgeos/shared`.
 */
...
export { createTool } from "@forgeos/shared";
export type {
	AgentEventListener,
	AgentRunInput,
	AgentRuntimeConfig,
