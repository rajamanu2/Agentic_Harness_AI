...
import type { ForgeOSAPI } from "../exports/forgeos"
import { setVscodeHostProviderMock } from "./host-provider-test-utils"

describe("ForgeOSAPI Core Functionality", () => {
	let api: ForgeOSAPI
	...
	beforeEach(async () => {
		...
		// Create a mock controller that matches what the real createForgeOSAPI expects
		...
		// Create API instance
		api = createForgeOSAPI(mockController)
	})
