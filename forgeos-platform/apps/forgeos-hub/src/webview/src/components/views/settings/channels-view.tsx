...
export function ChannelsContent() {
	...
	return (
		<PageFrame>
			<PageHeader
				description={`${activeConnectors.length} connected. Start and manage connector channels for ForgeOS Hub.`}
				title="Channels"
				meta={<CommandBadge>forgeos connect</CommandBadge>}
				actions={
					<>
						<Button
							disabled={isLoading}
			...
			<Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
				<DialogContent className="max-h-[86vh] overflow-y-auto sm:max-w-xl">
					<DialogHeader>
						...
						<DialogDescription>
							Start a connector channel for ForgeOS Hub.
						</DialogDescription>
					</DialogHeader>
