import {
	...
	ThinkingConfig,
} from "@shared/proto/forgeos/models"
import {
	ApiConfiguration,
	ApiProvider,
...
export function convertApiConfigurationToProto(config: ApiConfiguration): ProtoApiConfiguration {
	return {
		...
		forgeosAccountId: config.forgeosAccountId,
		ulid: config.ulid,
		...
		forgeosApiKey: config.forgeosApiKey,
		...
		planModeForgeOSModelId: config.planModeForgeOSModelId,
		planModeForgeOSModelInfo: convertModelInfoToProtoOpenRouter(config.planModeForgeOSModelInfo),
		planModeForgeOSPassModelId: config.planModeForgeOSPassModelId,
		planModeForgeOSPassModelInfo: convertModelInfoToProtoOpenRouter(config.planModeForgeOSPassModelInfo),
		...
		actModeForgeOSModelId: config.actModeForgeOSModelId,
		actModeForgeOSModelInfo: convertModelInfoToProtoOpenRouter(config.actModeForgeOSModelInfo),
		actModeForgeOSPassModelId: config.actModeForgeOSPassModelId,
		actModeForgeOSPassModelInfo: convertModelInfoToProtoOpenRouter(config.actModeForgeOSPassModelInfo),
...
export function convertProtoToApiConfiguration(protoConfig: ProtoApiConfiguration): ApiConfiguration {
	return {
		...
		forgeosAccountId: protoConfig.forgeosAccountId,
		...
		forgeosApiKey: protoConfig.forgeosApiKey,
		...
		planModeForgeOSModelId: protoConfig.planModeForgeOSModelId,
		planModeForgeOSModelInfo: convertProtoToModelInfo(protoConfig.planModeForgeOSModelInfo),
		planModeForgeOSPassModelId: protoConfig.planModeForgeOSPassModelId,
		planModeForgeOSPassModelInfo: convertProtoToModelInfo(protoConfig.planModeForgeOSPassModelInfo),
		...
		actModeForgeOSModelId: protoConfig.actModeForgeOSModelId,
		actModeForgeOSModelInfo: convertProtoToModelInfo(protoConfig.actModeForgeOSModelInfo),
		actModeForgeOSPassModelId: protoConfig.actModeForgeOSPassModelId,
		actModeForgeOSPassModelInfo: convertProtoToModelInfo(protoConfig.actModeForgeOSPassModelInfo),
