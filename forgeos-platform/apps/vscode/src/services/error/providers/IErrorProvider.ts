...
import type { ForgeOSError } from "../ForgeOSError"
...
export interface IErrorProvider {
	 ...
	 */
	captureException(error: Error | ForgeOSError, properties?: Record<string, unknown>): Promise<void>

	/**
	 * Sends a log message an error and optional properties
	 * @param error The error to log (Error or ForgeOSError)
	 * @param properties Optional additional properties to attach
	 */
	logException(error: Error | ForgeOSError, properties?: Record<string, unknown>): void
