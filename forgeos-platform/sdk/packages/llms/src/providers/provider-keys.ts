 ...
 * - `generatedProviderId` is ForgeOS's canonical ID for the provider spec and
 ...
 * supported AI SDK package. IDs use ForgeOS's generated provider identifiers
