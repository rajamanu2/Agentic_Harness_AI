...
/**
 * The IDE or client surface the user is running ForgeOS from.
 */
...
export interface ClientContext {
	/** Client type emitted to ForgeOS request headers, e.g. "VSCode Extension", "forgeos-cli", "forgeos-sdk" */
	name: ClientName;
	/** ForgeOS client/extension semver string, e.g. "3.12.0" */
	version?: string;
 ...
 * required by buildForgeOSSystemPrompt, so callers can spread a WorkspaceInfo
...
export interface WorkspaceContext extends WorkspaceInfo {
	...
	/**
	 * Pre-serialized workspace metadata block that replaces {{FORGEOS_METADATA}}
...
export interface ExtensionContext {
	 ...
	 * started through a ForgeOSCore instance with automation enabled.
	 */
