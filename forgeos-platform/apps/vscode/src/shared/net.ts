 ...
 * ## Proxy Support
 *
 * ForgeOS uses platform-specific fetch implementations to handle proxy
 * configuration:
 ...
 *
 * The CLI's npm wrapper (bin/forgeos) does the same automatically: it harvests
 ...
 * 3. View logs: Check ~/.forgeos/forgeos-core-service.log for network-related
 *    failures.
