...
import type { ForgeOSAccountSnapshot } from "./forgeos-account";
import type {
...
export interface TuiProps {
	...
	loadForgeOSAccount: () => Promise<ForgeOSAccountSnapshot>;
	loadIndividualSubscriptionPlans?: () => Promise<ForgeOSSubscriptionPlan[]>;
	switchForgeOSAccount: (organizationId?: string | null) => Promise<void>;
	loadConfigData: (
	 ...
	 * user accepts the "Hub was updated by another ForgeOS installation" dialog.
	 */
