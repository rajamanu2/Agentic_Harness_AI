...
title: "Agent"
sidebarTitle: "Agent"
description: "API reference for Agent / AgentRuntime from @forgeos/agents."
---

`Agent` is an alias for `AgentRuntime` from `@forgeos/agents`.

```typescript
import { Agent, AgentRuntime, createAgent, createAgentRuntime } from "@forgeos/sdk"
```
