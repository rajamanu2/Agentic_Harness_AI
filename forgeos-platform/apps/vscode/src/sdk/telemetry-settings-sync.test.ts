...
describe("syncTelemetrySettingFromSharedGlobalSettings", () => {
	...
	beforeEach(() => {
		previousSettingsPath = process.env.FORGEOS_GLOBAL_SETTINGS_PATH
		tempDir = mkdtempSync(join(tmpdir(), "forgeos-vscode-telemetry-sync-"))
	...
	afterEach(() => {
		if (previousSettingsPath === undefined) {
			...
			process.env.FORGEOS_GLOBAL_SETTINGS_PATH = previousSettingsPath
		}
