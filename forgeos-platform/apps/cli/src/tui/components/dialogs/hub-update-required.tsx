...
export function HubUpdateRequiredContent(
	...
	return (
		<box flexDirection="column" paddingX={1} gap={1}>
			<text fg="yellow">ForgeOS Hub was updated</text>
			<box flexDirection="column">
				<text selectable>
					Another ForgeOS installation restarted the shared ForgeOS Hub
					{hubCoreVersion ? ` (core ${hubCoreVersion})` : ""}, and it no longer
					matches this CLI.
				</text>
				<text selectable>
					Update and restart ForgeOS so this CLI and the Hub run the same version
					again.
				</text>
			</box>
