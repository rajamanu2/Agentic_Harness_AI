/**
 * Type definitions for ForgeOS Analysis Framework output
...
export interface AnalysisMetadata {
	...
	agent: string // Agent name (e.g., "forgeos-cli")
...
export type FailureCategory =
	| "provider_bug" // ForgeOS integration bugs (Gemini #7974, Claude #7998)
