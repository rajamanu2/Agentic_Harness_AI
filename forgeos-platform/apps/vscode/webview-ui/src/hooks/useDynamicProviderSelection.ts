 ...
 * Dynamic-list providers (openrouter, forgeos, openai-compatible, ollama,
...
const FALLBACK_INFO_BY_PROVIDER: Partial<Record<string, ModelInfo>> = {
	...
	forgeos: openRouterDefaultModelInfo,
...
export function useDynamicProviderSelection(
	...
	return useMemo(() => {
		...
		switch (providerId) {
			...
			case "forgeos":
				return resolve(fields.forgeosModelId, fields.forgeosModelInfo)
