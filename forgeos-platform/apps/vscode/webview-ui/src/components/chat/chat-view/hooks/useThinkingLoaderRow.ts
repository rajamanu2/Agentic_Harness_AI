...
export interface ThinkingLoaderInputs {
	...
	/** Tail of the raw forgeosMessages array. */
	lastRawMessage: ForgeOSMessage | undefined
	groupedMessages: (ForgeOSMessage | ForgeOSMessage[])[]
	/** Tail of groupedMessages. */
	lastVisibleRow: ForgeOSMessage | ForgeOSMessage[] | undefined
	/** Tail message of lastVisibleRow (last element when it is a group). */
	lastVisibleMessage: ForgeOSMessage | undefined
