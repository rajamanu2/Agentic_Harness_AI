	...
	<ChatFrame>
		...
		<Message from="assistant">
			...
			<MessageContent>
				...
				<ul className="forgeos-markdown list-disc pl-5">
	...
	<ChatFrame>
		...
		<Message from="assistant">
			...
			<ToolActivity expandable={false}>
				<ToolActivityTrigger
					icon={<TerminalIcon />}
					label="Running bun -F @forgeos/ui test"
					status="running"
				/>
			</ToolActivity>
				...
				<ToolActivityContent>
					<ToolActivityCode>
						{status === "error"
							...
							: "@forgeos/ui theme contract is valid"}
					</ToolActivityCode>
				</ToolActivityContent>
			</ToolActivity>
		))}
 ...
 * `@forgeos/ui/components/agent-chat/tool-summary` — the same payloads the
