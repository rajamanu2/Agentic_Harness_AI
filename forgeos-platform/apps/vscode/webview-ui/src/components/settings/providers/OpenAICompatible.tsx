...
import { OpenAiModelsRequest } from "@shared/proto/forgeos/models"
		...
		<div>
			...
			<p
				...
				<span style={{ color: "var(--vscode-errorForeground)" }}>
					(<span style={{ fontWeight: 500 }}>Note:</span> ForgeOS uses complex prompts, so behavior can vary across
