...
const createTextMessage = (ts: number, text: string): ForgeOSMessage => ({
	type: "say",
	say: "text",
	text,
	ts,
...
const createToolMessage = (ts: number, tool: string): ForgeOSMessage => ({
	type: "say",
	say: "tool",
...
const createReasoningMessage = (ts: number, text: string): ForgeOSMessage => ({
	type: "say",
	say: "reasoning",
	text,
	ts,
...
const createUserFeedbackMessage = (ts: number, text: string): ForgeOSMessage => ({
	type: "say",
	say: "user_feedback",
	text,
	ts,
...
const createTaskMessage = (ts: number, text: string): ForgeOSMessage => ({
	type: "say",
	say: "task",
	text,
	ts,
