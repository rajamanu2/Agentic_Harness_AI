...
// Used in forgeos.ts provider and in webview-ui/src/components/chat/ChatRow.tsx to display the login button
export const FORGEOS_ACCOUNT_AUTH_ERROR_MESSAGE = "Unauthorized: Please sign in to ForgeOS before trying again."
