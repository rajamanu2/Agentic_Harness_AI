...
export function AccountView() {
	...
	const signOut = async () => {
		...
		try {
			...
			resetAccountData();
			setActiveTab("overview");
			setOverviewError("No ForgeOS account auth token found");
		} catch (err) {
			const message = normalizeAccountViewError(err).message;
			setOverviewError(message);
		} finally {
			...
			<div className="mx-auto flex max-w-xl flex-col items-center gap-4 py-8 text-center">
				...
				<div>
					...
					<p className="mt-2 text-sm text-muted-foreground">
						...
						organization details from ForgeOS Hub.
					</p>
				</div>
						...
						<>
							...
							<div className="rounded-lg border border-border p-5">
								<div className="flex items-start gap-4">
									...
									<div className="flex shrink-0 items-center gap-2">
										<a
											href="https://app.forgeos.bot/dashboard"
											target="_blank"
											rel="noopener noreferrer"
							...
							{displayedBalance !== null && (
								<div className="rounded-lg border border-border p-5">
									<div className="flex items-center justify-between mb-4">
										...
										<a
											href="https://app.forgeos.bot/dashboard/organization?tab=credits&redirect=true"
											target="_blank"
											rel="noopener noreferrer"
							...
							<div className="rounded-lg border border-border p-5">
								<div className="flex items-center justify-between mb-4">
									...
									<a
										href="https://app.forgeos.bot/onboarding?step=1"
										target="_blank"
										rel="noopener noreferrer"
										className="flex items-center gap-1.5 rounded-md px-2.5 py-1.5 text-xs font-medium text-muted-foreground hover:bg-accent hover:text-foreground transition-colors"
									>
