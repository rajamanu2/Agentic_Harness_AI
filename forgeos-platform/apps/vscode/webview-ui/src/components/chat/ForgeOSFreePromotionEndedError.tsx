...
// Shown when a request targets a retired forgeos-free/ model: once its free
...
const ForgeOSFreePromotionEndedError = () => {
	...
	return (
		<div
			...
			data-testid="forgeos-free-promotion-ended-error">
...
export default ForgeOSFreePromotionEndedError
