...
/**
 * ForgeOSLogoVariable component renders the ForgeOS logo with automatic theme adaptation
 ...
 * @returns {JSX.Element} SVG ForgeOS logo that adapts to VS Code themes and environment
 */
const ForgeOSLogoVariable = (props: SVGProps<SVGSVGElement> & { environment?: Environment }) => {
...
export default ForgeOSLogoVariable
