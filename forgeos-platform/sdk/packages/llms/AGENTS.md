---
description: Development guidance for the @forgeos/llms package.
globs: "src/**/*.ts,src/**/*.tsx,*.md"
alwaysApply: true
---

# @forgeos/llms Development Guidance
...
- Do not build a broad ForgeOS-maintained model capability or behavior registry.
