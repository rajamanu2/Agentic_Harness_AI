---
title: "ForgeOS Telemetry"
sidebarTitle: "ForgeOS Telemetry"
description: "Configure usage analytics and event tracking"
---

ForgeOS includes telemetry to help understand usage patterns and improve the product. Users can control whether to share this data.

## What is ForgeOS Telemetry?
...
### Enabling/Disabling ForgeOS Telemetry

Individual users can control telemetry through ForgeOS settings:

1. Open ForgeOS settings
2. Find "ForgeOS Telemetry" toggle
...
When telemetry is enabled, ForgeOS captures:
...
ForgeOS Telemetry **never** includes:
...
<Note>
Even with enterprise configuration, individual users can still disable ForgeOS Telemetry in their local settings.
</Note>

## Enterprise Monitoring Features

For organizations with additional compliance or monitoring requirements, ForgeOS provides:
...
ForgeOS's telemetry is designed with privacy in mind:
