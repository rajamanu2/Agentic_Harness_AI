	...
	return (
		<PageFrame>
			<PageHeader
				...
				description="Connect messaging platforms so you can chat with ForgeOS anywhere. Click on a channel name to view or edit its configuration."
				meta={
