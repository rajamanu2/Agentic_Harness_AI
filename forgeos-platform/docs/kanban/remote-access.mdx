...
```bash
KANBAN_RUNTIME_HOST=0.0.0.0 forgeos
```

When you run `forgeos`, it will launch Kanban bound to `0.0.0.0`.
...
export class KanbanEc2Stack extends cdk.Stack {
    constructor(scope: Construct, id: string, props?: cdk.StackProps) {
        ...
        userData.addCommands(
            ...
            "git clone -b main https://github.com/forgeos/kanban.git /opt/kanban",
