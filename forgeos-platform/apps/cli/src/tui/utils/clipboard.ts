...
// FORGEOS_CLIPBOARD_FALLBACK_REMOTE=1 opts back in for users who explicitly
// want the remote machine's clipboard.
const CLIPBOARD_FALLBACK_REMOTE_ENV = "FORGEOS_CLIPBOARD_FALLBACK_REMOTE";

// Setting FORGEOS_DEBUG_CLIPBOARD=1 logs why the fallback skipped or which
// command failed; off by default so the TUI canvas stays clean.
const CLIPBOARD_DEBUG_ENV = "FORGEOS_DEBUG_CLIPBOARD";
