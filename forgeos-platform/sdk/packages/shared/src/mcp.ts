 ...
 *
 * The `timeout` field in forgeos_mcp_settings.json is in SECONDS. Every client
...
export function formatMcpTimeoutErrorMessage(
	...
	return (
		...
		`Increase the "timeout" field (in seconds) for this server in forgeos_mcp_settings.json.`
	);
}
