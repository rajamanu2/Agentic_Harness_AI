...
import type { GeneratedMedia } from "@forgeos/shared/browser";
...
let root: Root;
const createObjectURL = vi.fn(() => "blob:forgeos-generated-media");
...
describe("GeneratedMediaContent", () => {
	...
	it("revokes browser-owned URLs when the media changes", async () => {
		...
		expect(revokeObjectURL).toHaveBeenCalledWith("blob:forgeos-generated-media");
	});
});
