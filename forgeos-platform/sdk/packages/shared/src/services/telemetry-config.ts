...
export interface ForgeOSTelemetryServiceConfig extends OpenTelemetryClientConfig {
...
export function createForgeOSTelemetryServiceMetadata(
...
export function createForgeOSTelemetryServiceConfig(
	configOverrides: Partial<ForgeOSTelemetryServiceConfig> = {},
): ForgeOSTelemetryServiceConfig {
	return {
		...getTelemetryBuildTimeConfig(),
		...configOverrides,
		metadata: createForgeOSTelemetryServiceMetadata(configOverrides.metadata),
	};
}
