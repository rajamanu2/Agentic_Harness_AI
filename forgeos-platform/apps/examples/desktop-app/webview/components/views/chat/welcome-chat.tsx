...
import { AgentAurora, AgentHeroHeading } from "@forgeos/ui";
...
//
// import { isChatWorkspacePath } from "@forgeos/shared/browser";
// import { type AgentQuickAction, AgentQuickActions } from "@forgeos/ui";
	...
	return (
		...
		>
			...
			>
				...
				>
					{active ? (
						<div className="forgeos-view-enter">
							<AgentHeroHeading />
					...
					<div
						className={
							active
								? "hidden"
								: "forgeos-view-enter h-full min-h-0 overflow-hidden"
						}
					...
					{active ? (
						<AgentQuickActions
							actions={actions}
							className="forgeos-view-enter mt-11"
