...
const FEATURE_TIPS: FeatureTipItem[] = [
	{
		text: "Add a .forgeosrules file to your project root to give ForgeOS project-specific instructions.",
	},
	{
		text: "Switch to Plan Mode to discuss and plan an approach before ForgeOS takes action.",
	},
	{
		text: "Use @ in the chat input to add files, folders, or URLs as context for your task.",
	},
	{
		text: "Set up MCP Servers to give ForgeOS access to external tools and APIs.",
	},
	{
		text: "ForgeOS creates checkpoints after changes — you can always restore to a previous state.",
	},
	{
	...
	{
		text: "Use the quote button to select text from ForgeOS's response and reference it in your reply.",
	},
	{
		text: "You can drag and drop images into the chat to share screenshots with ForgeOS.",
	},
	{
 ...
 * Appears after a brief delay and cycles through tips while ForgeOS is thinking.
 */
