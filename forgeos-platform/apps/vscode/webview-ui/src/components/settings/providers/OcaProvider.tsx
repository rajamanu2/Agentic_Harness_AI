...
import type { OcaAuthState, OcaUserInfo } from "@shared/proto/index.forgeos"
import { EmptyRequest, StringRequest } from "@shared/proto/index.forgeos"
			...
			{!ready ? (
				...
				<div>
					...
					<p className="text-xs mt-0 text-(--vscode-descriptionForeground)">
						...
						please see the{" "}
						<VSCodeLink
							href="https://confluence.oraclecorp.com/confluence/display/AICODE/Oracle+Code+Assist+via+ForgeOS"
