...
describe("createContextCompactionPrepareTurn", () => {
	...
	it("skips with a diagnostic warning when the summarizer only produced reasoning output", async () => {
		// Repro for FORGEOS-2911: a reasoning model can spend the entire output
	...
	it("falls back to basic compaction when a custom compactor deforgeoss during overflow recovery", async () => {
