...
title: "TUI"
sidebarTitle: "TUI"
description: "Use ForgeOS's terminal UI (TUI) for interactive coding workflows in your terminal."
---

## What is the TUI?

The TUI is ForgeOS's interactive terminal interface. It is designed for conversational, in-terminal work: ask questions, review plans, approve actions, and iterate quickly.
