...
import { ForgeOSPassProvider } from "./providers/ForgeOSPassProvider"
import { ForgeOSProvider } from "./providers/ForgeOSProvider"
	...
	*/
	...
	return (
		<div
			...
			{apiConfiguration && selectedProvider === "forgeos" && (
				<ForgeOSProvider
			...
			{apiConfiguration && selectedProvider === "forgeos-pass" && (
				<ForgeOSPassProvider currentMode={currentMode} isPopup={isPopup} showModelOptions={showModelOptions} />
			)}
