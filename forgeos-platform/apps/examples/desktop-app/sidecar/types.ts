...
export type SidecarContext = {
	...
	sessionManager: ForgeOSCore | null;
...
export const SIDECAR_PORT = Number(process.env.FORGEOS_SIDECAR_PORT) || 3126;
// Loopback-only by default. Set FORGEOS_SIDECAR_HOST=0.0.0.0 to accept
// connections from outside the local host (e.g. Docker port publishing).
export const SIDECAR_HOST =
	process.env.FORGEOS_SIDECAR_HOST?.trim() || "127.0.0.1";
