...
title: "Errors"
sidebarTitle: "Errors"
description: "Error codes, error formats, mid-stream errors, and retry strategies for the ForgeOS API."
---

The ForgeOS API returns errors in a consistent JSON format. Understanding these errors helps you build reliable integrations.
...
| `402` | Payment Required | Insufficient credits | Add credits at [app.forgeos.bot](https://app.forgeos.bot) |
