...
// executed automatically to regenerate the proto/forgeos/state.proto file with the
...
const GLOBAL_STATE_FIELDS = {
	forgeosVersion: { default: undefined as string | undefined },
	"forgeos.generatedMachineId": { default: undefined as string | undefined }, // Note, distinctId reads/writes this directly from/to StorageContext before StateManager is initialized.
	...
	remoteRulesToggles: { default: {} as ForgeOSRulesToggles },
	remoteWorkflowToggles: { default: {} as ForgeOSRulesToggles },
	remoteSkillsToggles: { default: {} as ForgeOSRulesToggles },
	dismissedBanners: { default: [] as Array<{ bannerId: string; dismissedAt: number }> },
	// Path to worktree that should auto-open ForgeOS sidebar when launched
...
const API_HANDLER_SETTINGS_FIELDS = {
	...
	planModeForgeOSModelId: { default: undefined as string | undefined },
	planModeForgeOSModelInfo: { default: undefined as ModelInfo | undefined },
	planModeForgeOSPassModelId: { default: undefined as string | undefined },
	planModeForgeOSPassModelInfo: { default: undefined as ModelInfo | undefined },
	...
	actModeForgeOSModelId: { default: undefined as string | undefined },
	actModeForgeOSModelInfo: { default: undefined as ModelInfo | undefined },
	actModeForgeOSPassModelId: { default: undefined as string | undefined },
	actModeForgeOSPassModelInfo: { default: undefined as ModelInfo | undefined },
...
const USER_SETTINGS_FIELDS = {
	...
	globalForgeOSRulesToggles: { default: {} as ForgeOSRulesToggles },
	globalWorkflowToggles: { default: {} as ForgeOSRulesToggles },
...
const SECRETS_KEYS = [
	"apiKey",
	"forgeosApiKey",
	"forgeosAccountId", // ForgeOS Account ID for Firebase
	"forgeos:forgeosAccountId",
	"openRouterApiKey",
	"awsAccessKey",
	"awsSecretKey",
	"awsSessionToken",
...
export type LocalState = { [K in (typeof LocalStateKeys)[number]]: ForgeOSRulesToggles }
