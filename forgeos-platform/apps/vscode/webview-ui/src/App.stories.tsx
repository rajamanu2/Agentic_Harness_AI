...
import type { ForgeOSMessage, ForgeOSSayTool } from "@shared/ExtensionMessage"
...
const meta: Meta<typeof MockApp> = {
	...
	parameters: {
		...
		docs: {
			description: {
				component: `
The ChatView component is the main interface for interacting with ForgeOS. It provides a comprehensive chat experience with AI assistance, task management, and various tools.
...
const createMessage = (
	minutesAgo: number,
	type: ForgeOSMessage["type"],
	say: ForgeOSMessage["say"],
	text: string,
	overrides: Partial<ForgeOSMessage> = {},
): ForgeOSMessage => ({
...
const mockActiveMessages: ForgeOSMessage[] = [
...
const mockStreamingMessages: ForgeOSMessage[] = [
	...mockActiveMessages,
	createMessage(
		0.17,
		"say",
...
const createMockState = (overrides: any = {}) => ({
	...
	showWelcome: false,
	forgeosMessages: mockActiveMessages,
...
export const Welcome: Story = {
	decorators: [createStoryDecorator({ welcomeViewCompleted: false, showWelcome: true, forgeosMessages: [] })],
	parameters: {
		docs: {
			description: {
...
export const Onboarding: Story = {
	...
	play: async ({ canvasElement }) => {
		...
		const title = canvas.getByText("How will you use ForgeOS?")
		...
		await expect(canvas.getByText("How will you use ForgeOS?")).toBeInTheDocument()
...
export const EmptyState: Story = {
	decorators: [createStoryDecorator({ forgeosMessages: [], taskHistory: [], isNewUser: true, showAnnouncement: true })],
	parameters: {
		docs: {
			description: {
...
export const ReturnUser: Story = {
	decorators: [
		createStoryDecorator({ forgeosMessages: [], taskHistory: mockTaskHistory, isNewUser: true, showAnnouncement: false }),
	],
	parameters: {
		docs: {
			description: {
...
export const ActiveConversation: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "An active conversation showing a typical interaction with ForgeOS, including task creation, tool usage, and AI responses.",
			},
		},
	},
}
...
export const StreamingResponse: Story = {
	decorators: [createStoryDecorator({ forgeosMessages: mockStreamingMessages })],
	parameters: {
		docs: {
			description: {
...
const createLongMessages = (): ForgeOSMessage[] => [
...
export const LongConversation: Story = {
	decorators: [createStoryDecorator({ forgeosMessages: createLongMessages() })],
	parameters: {
		docs: {
			description: {
...
export const ErrorState: Story = {
	decorators: [createStoryDecorator({ forgeosMessages: createErrorMessages() })],
	parameters: {
		docs: {
			description: {
				story: "Shows how ForgeOS handles and displays error messages, helping users understand and resolve issues.",
			},
		},
	},
}
...
export const AutoApprovalEnabled: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Shows the interface with auto-approval enabled, allowing ForgeOS to execute certain actions automatically without user confirmation.",
			},
		},
	},
}
...
export const PlanMode: Story = {
	decorators: [
		createStoryDecorator({
			forgeosMessages: createPlanModeMessages(),
	...
	parameters: {
		docs: {
			description: {
				story: "Shows ForgeOS in Plan mode, where it focuses on creating detailed plans and discussing approaches before implementation.",
			},
		},
	},
}
...
export const BrowserAutomation: Story = {
	decorators: [createStoryDecorator({ forgeosMessages: createBrowserMessages() })],
	parameters: {
		docs: {
			description: {
				story: "Shows ForgeOS performing browser automation tasks, including launching browsers, clicking elements, and testing web applications.",
			},
		},
	},
}
...
export const ToolApproval: Story = {
	decorators: [createStoryDecorator({ forgeosMessages: createToolApprovalMessages() })],
	parameters: {
		docs: {
			description: {
...
export const Followup = quickStory(
	...
	"Shows followup question state where ForgeOS asks for next steps.",
)
...
export const PlanModeResponse = quickStory(
	...
	"plan_mode_respond",
	"Here's my comprehensive plan for refactoring your React application with TypeScript migration and performance optimization phases.\n\n\n\n\nPhase 1: TypeScript Migration\n1. Set up TypeScript in the project\n2. Rename .js files to .tsx/.ts\n3. Add type definitions for components and props\n4. Fix type errors and ensure type safety\n\nPhase 2: Performance Optimization\n1. Analyze current performance bottlenecks\n2. Implement code-splitting and lazy loading\n3. Optimize rendering with React.memo and useCallback\n4. Minimize bundle size with tree-shaking and minification\n5. Test performance improvements using profiling tools",
	"Shows plan mode response where ForgeOS presents a detailed plan for user approval.",
)
...
export const ReportBug = quickStory(
	...
	"report_bug",
	JSON.stringify({
		steps_to_reproduce: "1. Open ForgeOS\n2. Start a new task\n3. Observe the error",
		what_happened: "ForgeOS crashes unexpectedly",
	}),
...
export const DiffEditNewFormat: Story = {
	decorators: [createStoryDecorator({ backgroundEditEnabled: true, forgeosMessages: createNewFormatMultiFileMessages() })],
	parameters: {
		docs: {
			description: {
...
export const DiffEditNewFormatStreaming: Story = {
	decorators: [
		(Story) => {
			const [messages, setMessages] = useState<ForgeOSMessage[]>([
			...
			const mockState = useMemo(() => createMockState({ backgroundEditEnabled: true, forgeosMessages: messages }), [messages])
...
*** End Patch`
				...
				const timer1 = setTimeout(() => {
					setMessages((prev: ForgeOSMessage[]) => [
						...prev,
...
export const DiffEditReplaceDiffFormat: Story = {
	decorators: [createStoryDecorator({ backgroundEditEnabled: true, forgeosMessages: createReplaceDiffFormatPatchMessages() })],
	parameters: {
		docs: {
			description: {
...
export const DiffEditMixedFormats: Story = {
	decorators: [createStoryDecorator({ forgeosMessages: createMixedFormatMessages() })],
	parameters: {
		docs: {
			description: {
