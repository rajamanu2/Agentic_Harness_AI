...
export function AgentAurora() {
	return (
		<div aria-hidden="true" className="forgeos-ui-agent-aurora">
			<div className="forgeos-ui-agent-aurora__horizon forgeos-ui-agent-aurora__soft-band" />
			<div className="forgeos-ui-agent-aurora__current forgeos-ui-agent-aurora__current--left forgeos-ui-agent-aurora__soft-band" />
			<div className="forgeos-ui-agent-aurora__current forgeos-ui-agent-aurora__current--right forgeos-ui-agent-aurora__soft-band" />
			{BLOBS.map((blob) => (
				<div
					className={`forgeos-ui-agent-aurora__blob forgeos-ui-agent-aurora__blob--${blob.position}`}
					key={blob.id}
					style={{
			...
			{STARS.map((star) => (
				<span
					className="forgeos-ui-agent-aurora__star"
