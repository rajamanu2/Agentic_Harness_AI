import { ForgeOSRulesToggles, RuleScope, ToggleWorkflowRequest } from "@shared/proto/forgeos/file"
 ...
 */
export async function toggleWorkflow(controller: Controller, request: ToggleWorkflowRequest): Promise<ForgeOSRulesToggles> {
	...
	return ForgeOSRulesToggles.create({ toggles: toggles })
}
