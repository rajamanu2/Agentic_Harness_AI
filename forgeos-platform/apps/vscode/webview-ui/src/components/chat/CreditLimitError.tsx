...
const DEFAULT_BUY_CREDITS_URL = {
	USER: "https://app.forgeos.bot/dashboard/account?tab=credits&redirect=true",
	ORG: "https://app.forgeos.bot/dashboard/organization?tab=credits&redirect=true",
}
...
const CreditLimitError: React.FC<CreditLimitErrorProps> = ({
	...
	const { activeOrganization } = useForgeOSAuth()
