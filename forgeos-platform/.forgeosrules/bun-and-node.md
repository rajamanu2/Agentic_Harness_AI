...
`dist/extension.js` as CommonJS under Node, and the standalone `forgeos-core` is a
...
| `NODE_PATH=... node forgeos-core.js` | The standalone core is launched by Node, not bun. |
