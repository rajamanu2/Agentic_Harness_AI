...
import type { ForgeOSAccountUserInfo } from "../../../auth/AuthService"
...
export class OpenTelemetryTelemetryProvider implements ITelemetryProvider {
	...
	constructor(
		...
		if (meterProvider) {
			this.meter = meterProvider.getMeter("forgeos")
			this.meterProvider = meterProvider
		}

		if (loggerProvider) {
			this.logger = loggerProvider.getLogger("forgeos")
	...
	public identifyUser(userInfo: ForgeOSAccountUserInfo, properties: TelemetryProperties = {}): void {
	 ...
	 */
	private buildUserAttributes(userInfo: ForgeOSAccountUserInfo, properties: TelemetryProperties = {}): Record<string, string> {
