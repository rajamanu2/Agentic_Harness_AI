...
const ProviderKeyMap: Partial<Record<ApiProvider, string>> = {
	...
	forgeos: "ForgeOSModelId",
	"forgeos-pass": "ForgeOSPassModelId",
 ...
 * provider. Dynamic-list providers (openrouter, forgeos, requesty, etc.)
...
const NON_SDK_PROVIDER_DEFAULTS: Partial<Record<ApiProvider, string>> = {
	...
	forgeos: openRouterDefaultModelId,
	"forgeos-pass": forgeosPassDefaultModelId,
