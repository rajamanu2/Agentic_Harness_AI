...
- [Shared Configuration in ForgeOS](#shared-configuration-in-forgeos)
- [Providers](#providers)
  - [AIHubMix](#aihubmix)
  - [AskSage](#asksage)
  - [Baseten](#baseten)
...
## Shared Configuration in ForgeOS

1. Open ForgeOS settings (⚙️).
...
For the full auth flow (IDE + CLI), see [Authorization & Model Selection](/getting-started/authorizing-with-forgeos#menu).
...
3. In ForgeOS, choose **AIHubMix** and paste the key.
...
3. In ForgeOS, select **AskSage** and enter the key.
...
3. In ForgeOS, choose **Baseten** and paste the key.
...
3. In ForgeOS, select **Cerebras** and enter the key.
...
3. In ForgeOS, select **Dify.ai** and paste your key.
...
3. In ForgeOS, select **Doubao** and paste credentials.
...
3. In ForgeOS, choose **Fireworks AI** and enter the key.
...
3. In ForgeOS, select **GCP Vertex AI** and provide required config values.
...
2. Create an API key.
3. In ForgeOS, select **Groq** and paste the key.
...
3. In ForgeOS, choose **Hicap** and enter the credential.
...
3. In ForgeOS, select **Huawei Cloud MaaS** and add credentials.
...
3. In ForgeOS, select **Hugging Face** and paste the token.
...
3. In ForgeOS, choose **Mistral** and paste the key.
...
3. In ForgeOS, select **Moonshot** and enter the key.
...
3. In ForgeOS, choose **Nebius AI Studio** and provide the credential.
...
3. In ForgeOS, select **NousResearch** and add credentials.
...
3. In ForgeOS, select **Qwen Code** and enter the credential.
...
2. Generate an API key.
3. In ForgeOS, select **Requesty** and paste the key.
...
3. In ForgeOS, choose **SambaNova** and enter credentials.
...
3. In ForgeOS, select **SAP AI Core** and provide required values.
...
2. Generate an API key.
3. In ForgeOS, choose **Together** and paste the key.
...
3. In ForgeOS, select **Vercel AI Gateway** and add the key.

### VS Code Language Model API
VS Code Language Model API support lets ForgeOS use models exposed by the VS Code host environment.
...
3. In ForgeOS, select **VS Code Language Model API**.
...
2. Generate an API key.
3. In ForgeOS, choose **xAI (Grok)** and paste the key.