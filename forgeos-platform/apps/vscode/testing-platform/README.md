# ForgeOS Testing Platform

A CLI testing framework for the ForgeOS Core extension, providing gRPC-based integration clients and utilities for automated scenarios.

## Overview

The platform enables end-to-end validation of ForgeOS's core functionality through:

- **gRPC Adapters** – clients for ForgeOS’s gRPC services  
...
Generate proto files in the **root ForgeOS project**:
...
From the root of the ForgeOS project:
...
Before running specs, make sure the standalone ForgeOS Core gRPC server (that runs mocks and host gRPC as well) is running:
