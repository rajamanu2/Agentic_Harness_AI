			...
			agents: [
				{
					...
					status: "completed",
					prompt:
						"In /Users/beatrix/dev/forgeose/apps/examples/desktop-app, investigate the triggers, algorithm/data flow, persistence/state behavior, provider wiring and everything else",
					lastAction: "Running read_files",
					startedAt: "2026-07-27T00:00:00.000Z",
					hasMessages: true,
				},
