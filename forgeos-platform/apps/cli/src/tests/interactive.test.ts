...
test.describe("forgeos interactive basics", () => {
	test.use({
		program: { file: FORGEOS_BIN, args: [] },
		rows: 50,
		columns: 120,
...
test.describe("forgeos interactive provider flag", () => {
	test.use({
		program: { file: FORGEOS_BIN, args: ["-P", "forgeos"] },
		rows: 50,
		columns: 120,
		env: forgeosEnv("default"),
	});
