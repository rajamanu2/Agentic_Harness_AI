...
const ChatView = ({ isHidden, showAnnouncement, hideAnnouncement, showHistoryView }: ChatViewProps) => {
	...
	const isProdHostedApp = userInfo?.apiBaseUrl === "https://app.forgeos.bot"
	...
	const task = useMemo(() => displayMessages.at(0), [displayMessages]) // leaving this less safe version here since if the first message is not a task, then the extension is in a bad state and needs to be debugged (see ForgeOS.abort)
