...
import { resolveForgeOSDataDir, resolveForgeOSDir } from "@forgeos/shared/storage";
import corePackage from "../../../package.json";

declare const __FORGEOS_CORE_RUNTIME_BUILD_ID__: string | undefined;
declare const __FORGEOS_CORE_RUNTIME_BUILD_EPOCH_MS__: number | undefined;

const HUB_DISCOVERY_ENV = "FORGEOS_HUB_DISCOVERY_PATH";
const HUB_BUILD_ID_ENV = "FORGEOS_HUB_BUILD_ID";
const HUB_BUILD_EPOCH_ENV = "FORGEOS_HUB_BUILD_EPOCH_MS";
...
export function resolveHubBuildId(): string {
	...
	const embedded =
		typeof __FORGEOS_CORE_RUNTIME_BUILD_ID__ === "string"
			? __FORGEOS_CORE_RUNTIME_BUILD_ID__.trim()
			: "";
...
export function resolveHubBuildEpochMs(): number | undefined {
	...
	return typeof __FORGEOS_CORE_RUNTIME_BUILD_EPOCH_MS__ === "number" &&
		Number.isFinite(__FORGEOS_CORE_RUNTIME_BUILD_EPOCH_MS__)
		? __FORGEOS_CORE_RUNTIME_BUILD_EPOCH_MS__
		: undefined;
}
...
/**
 * Compatibility for a managed local Hub discovered through ForgeOS's owner
...
export { resolveForgeOSDataDir, resolveForgeOSDir };
