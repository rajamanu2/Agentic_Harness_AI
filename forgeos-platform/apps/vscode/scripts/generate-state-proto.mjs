 ...
 *
 * The generated proto content is written to proto/forgeos/state.proto,
...
const STATE_PROTO_PATH = "proto/forgeos/state.proto"
...
function parseSecretsKeys(sourceFile) {
	...
	for (const element of initializer.getElements()) {
		...
		// Skip prefixed keys like "forgeos:forgeosAccountId"
		if (!key.includes(":")) {
			keys.push(key)
		}
	}
