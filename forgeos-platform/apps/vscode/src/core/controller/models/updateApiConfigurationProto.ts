...
import type { UpdateApiConfigurationRequest } from "@shared/proto/forgeos/models"
	...
	try {
		...
		const convertedApiConfigurationFromProto = {
			...
			planModeOpenRouterModelInfo: protoApiConfiguration.planModeOpenRouterModelInfo
				...
				: undefined,
			planModeForgeOSModelInfo: protoApiConfiguration.planModeForgeOSModelInfo
				? fromProtobufModelInfo(protoApiConfiguration.planModeForgeOSModelInfo)
				: undefined,
			planModeForgeOSPassModelInfo: protoApiConfiguration.planModeForgeOSPassModelInfo
				? fromProtobufModelInfo(protoApiConfiguration.planModeForgeOSPassModelInfo)
				: undefined,
			...
			actModeOpenRouterModelInfo: protoApiConfiguration.actModeOpenRouterModelInfo
				...
				: undefined,
			actModeForgeOSModelInfo: protoApiConfiguration.actModeForgeOSModelInfo
				? fromProtobufModelInfo(protoApiConfiguration.actModeForgeOSModelInfo)
				: undefined,
			actModeForgeOSPassModelInfo: protoApiConfiguration.actModeForgeOSPassModelInfo
				? fromProtobufModelInfo(protoApiConfiguration.actModeForgeOSPassModelInfo)
				: undefined,
		...
		clearOrganizationForForgeOSPassProviderSelection(controller, normalizedApiConfiguration)
