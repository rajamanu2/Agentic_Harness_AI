...
export interface PluginSetupContext {
	...
	/** Host/client identity such as `forgeos-cli`, `forgeos-vscode`, or an SDK app. */
	...
	/**
	 * Automation ingress made available by hosts that enable ForgeOSCore
 ...
 * (e.g. `AgentExtension` in `@forgeos/agents`) narrow them to the correct
...
> {
	...
	disabled?: boolean;
	/** Runtime-native hooks consumed directly by `@forgeos/agents`. */
