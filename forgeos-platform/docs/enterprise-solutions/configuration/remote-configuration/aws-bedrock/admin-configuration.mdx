...
description: "This guide explains how administrators configure AWS Bedrock as the organization-wide LLM provider for ForgeOS."
---


As an administrator, you can add AWS Bedrock as the organization-wide LLM provider for all ForgeOS users through the hosted admin console. This centralized approach ensures consistent access to Amazon's AI models while maintaining your organization's security and compliance requirements through region controls and basic configuration options.
...
Your AWS account needs specific Bedrock permissions to work with ForgeOS. 
...
<Frame>
	<img
		src="https://assets.int.forgeos.bot/assets/AWS%20Remote%20Config.gif"
	/>
</Frame>
...
Once saved, all organization members signed into the ForgeOS extension will automatically use AWS Bedrock with your configured settings. They won't be able to select other providers or switch to their personal ForgeOS accounts.
