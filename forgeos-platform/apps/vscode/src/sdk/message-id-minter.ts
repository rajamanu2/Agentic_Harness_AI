// Single source of truth for ForgeOSMessage identity (`id`), update freshness (`seq`),
// and the conversation/replica fence (`epoch`).
//
// Rationale (why this exists):
// - `ForgeOSMessage.ts` is used as a message IDENTITY / merge key, not as a wall clock. It
 ...
 * - history rendering (sdkMessagesToForgeOSMessages).
 *
