...
import { loginAndSaveProviderOAuthCredentials } from "@forgeos/core";
...
export const ACP_AUTH_METHODS = [
	{ id: "forgeos", name: "Sign in with ForgeOS" },
	{ id: "forgeos-pass", name: "Sign in with ForgeOSPass" },
...
async function performOAuthLogin(input: {
	...
	const [{ createOAuthClientCallbacks }, { default: open }] = await Promise.all(
		[import("@forgeos/core"), import("../utils/open")],
	);
