...
description: "Run ForgeOS with local models using Ollama, LM Studio or Atomic Chat."
---

Run ForgeOS with local inference on your machine.

## Quick Start

1. Install a local runtime (**Ollama**, **LM Studio** or **Atomic Chat**)
2. Start the local server
3. In ForgeOS Settings, select the matching provider
4. Select a local model
5. Enable **Use Compact Prompt** in ForgeOS Settings → Features
...
## Recommended ForgeOS Settings for Local Inference
