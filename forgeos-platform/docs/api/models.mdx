...
title: "Models"
sidebarTitle: "Models"
description: "Available models, pricing tiers, free models, and how model IDs work in the ForgeOS API."
---

The ForgeOS API gives you access to models from multiple providers through a single endpoint. Model IDs follow the `provider/model-name` format, the same convention used by [OpenRouter](https://openrouter.ai).
...
For setup and account flow details, see the [ForgeOS Provider guide](/getting-started/forgeos-provider).
...
<CardGroup cols={2}>
  ...
  <Card title="ForgeOS Provider" icon="scale-balanced" href="/getting-started/forgeos-provider">
