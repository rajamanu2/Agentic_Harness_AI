...
/**
 * Combines sequences of command and command_output messages in an array of ForgeOSMessages.
 *
 * This function processes an array of ForgeOSMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of ForgeOSMessage objects to process.
 * @returns A new array of ForgeOSMessage objects with command sequences combined.
 *
 * @example
 ...
 */
export function combineCommandSequences(messages: ForgeOSMessage[]): ForgeOSMessage[] {
	const combinedCommands: ForgeOSMessage[] = []
