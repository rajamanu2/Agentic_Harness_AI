...
// ProviderSettingsManager.write). Concurrent ForgeOS processes (CLI, extension,
...
/**
 * Apply a single provider's updated models.json entry to the live @forgeos/llms
...
/**
 * Load models.json into the @forgeos/llms registry at most once per path per
