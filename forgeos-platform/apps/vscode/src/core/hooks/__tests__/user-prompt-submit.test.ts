...
import { HookOutput } from "../../../shared/proto/forgeos/hooks"
...
describe("UserPromptSubmit Hook", () => {
	...
	describe("Hook Input Format", () => {
		it("should receive prompt text from user content", async () => {
			const hookPath = path.join(tempDir, ".forgeosrules", "hooks", "UserPromptSubmit")
...
console.log(JSON.stringify({
  ...
  contextModification: "GLOBAL: Prompt received"
			...
			const workspaceHookPath = path.join(tempDir, ".forgeosrules", "hooks", "UserPromptSubmit")
