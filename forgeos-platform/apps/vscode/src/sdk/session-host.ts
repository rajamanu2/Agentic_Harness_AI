...
export interface SdkSessionHost {
	...
	list(limit?: number, options?: Omit<ForgeOSCoreListHistoryOptions, "limit">): Promise<SessionHistoryRecord[]>
	listHistory(options?: ForgeOSCoreListHistoryOptions): Promise<SessionHistoryRecord[]>
