/**
 * Failure classification system for ForgeOS evaluations
 *
...
export class FailureClassifier {
	...
	constructor(patternsPath?: string) {
		const defaultPath = path.join(__dirname, "../patterns/forgeos-failures.yaml")
	 ...
	 * @param logs Full log text (e.g., forgeos.txt content)
