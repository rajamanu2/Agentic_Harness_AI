...
```bash
forgeos --team-name auth-sprint "Continue with incomplete tasks"
```
...
Team state is stored at `~/.forgeos/data/teams/[team-name]/` and includes:
