import { setCompactionStrategyGlobally, setModelToolEnabledGlobally } from "@forgeos/core"
import { Empty } from "@shared/proto/forgeos/common"
import { PlanActMode, McpDisplayMode as ProtoMcpDisplayMode, UpdateSettingsRequest } from "@shared/proto/forgeos/state"
...
export async function updateSettings(controller: Controller, request: UpdateSettingsRequest): Promise<Empty> {
	try {
		if (request.forgeosEnv !== undefined && request.forgeosEnv !== "") {
			ForgeOSEnv.setEnvironment(request.forgeosEnv)
