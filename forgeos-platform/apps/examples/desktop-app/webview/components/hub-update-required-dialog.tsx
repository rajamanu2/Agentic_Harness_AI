...
/**
 * Blocking prompt shown when the sidecar reports that another ForgeOS
 * installation (for example an updated CLI) replaced the shared ForgeOS Hub
...
export function HubUpdateRequiredDialog() {
	...
	return (
		...
		>
			<AlertDialogContent>
				<AlertDialogHeader>
					<AlertDialogTitle>ForgeOS Hub was updated</AlertDialogTitle>
					<AlertDialogDescription>
						Another ForgeOS installation updated the shared ForgeOS Hub
						{mismatch?.hubCoreVersion
							? ` (core ${mismatch.hubCoreVersion})`
							: ""}
						, and it no longer matches this app. Update and restart ForgeOS Code
