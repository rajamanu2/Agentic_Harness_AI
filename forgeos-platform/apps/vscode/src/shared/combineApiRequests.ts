...
/**
 * Combines API request start and finish messages in an array of ForgeOSMessages.
 *
 ...
 * @returns A new array of ForgeOSMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: ForgeOSMessage[]): ForgeOSMessage[] {
	const combinedApiRequests: ForgeOSMessage[] = []
