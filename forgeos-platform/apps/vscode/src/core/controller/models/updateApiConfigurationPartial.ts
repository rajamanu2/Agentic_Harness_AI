...
import { UpdateApiConfigurationPartialRequest } from "@shared/proto/forgeos/models"
...
export async function updateApiConfigurationPartial(
	...
	try {
		...
		clearOrganizationForForgeOSPassProviderSelection(controller, normalizedConfig)
		if (controller.task) {
