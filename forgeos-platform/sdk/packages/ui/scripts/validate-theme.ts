...
if (
	palette.includes("--forgeos-") ||
	tokens.includes("--forgeos-") ||
	theme.includes("--forgeos-") ||
	base.includes("--forgeos-")
) {
	throw new Error("theme contract must not expose --forgeos-* variables");
}
if (
...
if (!tokensWithoutComments.includes('@import "@forgeos/ui/theme/palette.css";')) {
...
if (
	...
	!componentTheme.includes("@custom-variant forgeos-ui-dark") ||
...
if (
	!index.includes('@import "@forgeos/ui/theme/tokens.css";') ||
	!index.includes('@import "@forgeos/ui/theme/theme.css";') ||
	!index.includes('@import "@forgeos/ui/theme/base.css";')
) {
...
console.log("@forgeos/ui theme contract is valid");
