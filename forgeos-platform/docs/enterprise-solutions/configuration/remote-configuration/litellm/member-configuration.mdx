...
<Tip>
API keys are stored locally in VS Code and are only used by the ForgeOS extension.
</Tip>
</Accordion>
...
Send a test message in ForgeOS to verify your connection works correctly with the LiteLLM proxy.
...
Confirm you're signed into the correct ForgeOS organization. Verify your administrator has saved the LiteLLM configuration and that you have the latest version of the ForgeOS extension.
...
- Regularly update the ForgeOS extension for security patches
