 ...
 * that data to the shared file-backed stores in ~/.forgeos/data/ so all platforms
 ...
 *   globalStorageFsPath is still the VSCode-managed path (not ~/.forgeos/data/),
 ...
 *   to ~/.forgeos/data/ so that tasks created in VSCode are visible in CLI/JetBrains
