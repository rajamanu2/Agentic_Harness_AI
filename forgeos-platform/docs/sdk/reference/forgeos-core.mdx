...
description: "API reference for ForgeOSCore from @forgeos/core."
---
...
| `automation` | `boolean \| ForgeOSCoreAutomationOptions` | Enable automation APIs |
...
When `automation` is enabled, use `forgeos.automation` to start/stop automation services, reconcile specs, ingest events, and list events/specs/runs.
