import { UpdateTerminalConnectionTimeoutResponse } from "@shared/proto/index.forgeos"
				...
				<div className="mb-5" id="terminal-settings-section">
					{isVsCodePlatform && (
						<div className="mb-4">
							...
							<p className="text-xs text-[var(--vscode-descriptionForeground)] mt-1">
								Choose whether ForgeOS runs commands in the VS Code terminal or a background process.
							</p>
						</div>
					)}
						...
						<>
							<div className="mb-4">
								...
								<p className="text-xs text-(--vscode-descriptionForeground)">
									Set how long ForgeOS waits for shell integration to activate before executing commands. Increase
							...
							<div className="mb-4">
								...
								<p className="text-xs text-(--vscode-descriptionForeground)">
									When enabled, ForgeOS will reuse existing terminal windows that aren't in the current working
					...
					<div className="mb-4">
						...
						<p className="text-xs text-(--vscode-descriptionForeground) mt-1">
							Select the default terminal ForgeOS will use. 'Default' uses your VSCode global setting.
						</p>
					</div>
					<div className="mt-5 p-3 bg-(--vscode-textBlockQuote-background) rounded border border-(--vscode-textBlockQuote-border)">
						<p className="text-[13px] m-0">
							...
							<a
								...
								href="https://docs.forgeos.bot/troubleshooting/terminal-quick-fixes"
							...
							<a
								className="text-(--vscode-textLink-foreground) underline hover:no-underline"
								href="https://docs.forgeos.bot/troubleshooting/terminal-integration-guide"
								rel="noopener noreferrer"
								target="_blank">
