...
import { CreateHookRequest, DeleteHookRequest, ToggleHookRequest } from "../shared/proto/forgeos/file"
...
describe("Hook Management", () => {
	...
	beforeEach(async () => {
		...
		globalHooksDir = path.join(tempDir, "global", "Documents", "ForgeOS", "Hooks")
		workspaceHooksDir = path.join(tempDir, "workspace", ".forgeosrules", "hooks")
	...
	describe("Edge Cases", () => {
		it("should handle missing .forgeosrules directory gracefully", async () => {
