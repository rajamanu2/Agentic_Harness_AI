/**
 * Telemetry adapter interface for the @forgeos/core SDK.
 *
...
import type { TelemetryProperties } from "@forgeos/shared";
 ...
 * provided {@link OpenTelemetryAdapter}) to receive ForgeOS telemetry events.
 *
