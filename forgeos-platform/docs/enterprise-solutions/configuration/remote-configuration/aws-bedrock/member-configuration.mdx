...
**ForgeOS extension installed and configured**  
The ForgeOS extension must be installed in VS Code and you need to be signed into your organization account. If you haven't installed ForgeOS yet, follow our [installation guide](/getting-started/installing-forgeos).

<Info>
**Quick Check**: Open the ForgeOS panel in VS Code. If you see your organization name in the bottom left, you're signed in correctly.
</Info>
...
<Frame>
	<img
		src="https://assets.int.forgeos.bot/assets/VS%20Code%20Bedrock%20API%20Key.gif"
	/>
</Frame>
...
Open VS Code and access the ForgeOS settings panel using either of these methods:
...
3. ForgeOS will use the credentials associated with that profile
</Accordion>
...
2. ForgeOS will automatically detect credentials from your environment using the standard AWS credential provider chain
</Accordion>
</AccordionGroup>
...
Send a test message in ForgeOS to verify your credentials work correctly with the configured Bedrock region.
...
Confirm you're signed into the correct ForgeOS organization. Verify your administrator has saved the Bedrock configuration. Try signing out and back into the extension.
