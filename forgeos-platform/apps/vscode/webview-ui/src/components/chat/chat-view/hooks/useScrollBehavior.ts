...
export function useScrollBehavior(
	...
	visibleMessages: ForgeOSMessage[],
	...
	scrolledPastUserMessage: ForgeOSMessage | null
	...
	const [scrolledPastUserMessage, setScrolledPastUserMessage] = useState<ForgeOSMessage | null>(null)
	...
	const checkScrolledPastUserMessage = useCallback(() => {
		...
		let mostRecentScrolledPast: ForgeOSMessage | null = null
