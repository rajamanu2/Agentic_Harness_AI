import type { ToggleAgentsRuleRequest } from "@shared/proto/forgeos/file"
import { ForgeOSRulesToggles } from "@shared/proto/forgeos/file"
 ...
 */
export async function toggleAgentsRule(controller: Controller, request: ToggleAgentsRuleRequest): Promise<ForgeOSRulesToggles> {
	...
	return ForgeOSRulesToggles.create({
