 ...
 * hard failures on openrouter, forgeos, and generic OpenAI-compatible
 ...
 * turn, which must never be retried because ForgeOS runs its own tool loop).
 */
...
describe("openai-compatible wire format (openrouter / forgeos / custom endpoints)", () => {
