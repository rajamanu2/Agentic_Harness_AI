// Converts ForgeOS SDK messages (@forgeos/llms `Message`) into VS Code Language
...
import type { ContentBlock, Message } from "@forgeos/llms"
...
export function asObjectSafe(value: unknown): object {
	...
	try {
		...
		Logger.warn("ForgeOS <Language Model API>: Failed to parse object:", error)
		return {}
	}
}
