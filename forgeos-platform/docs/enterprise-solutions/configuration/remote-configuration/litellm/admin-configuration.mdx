...
description: "This guide explains how administrators configure LiteLLM as the organization-wide LLM provider for ForgeOS."
---


As an administrator, you can add LiteLLM as the organization-wide LLM provider for all ForgeOS users through the hosted admin console. This centralized approach provides unified access to multiple AI models through your LiteLLM proxy interface.
...
Once saved, all organization members signed into the ForgeOS extension will automatically use LiteLLM with your configured settings. They won't be able to select other providers or switch to their personal ForgeOS accounts.
