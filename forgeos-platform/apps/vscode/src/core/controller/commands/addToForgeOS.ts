...
// 'Add to ForgeOS' context menu in editor and code action
// Inserts the selected code into the chat.
export async function addToForgeOS(controller: Controller, request: CommandContext, notebookContext?: string): Promise<Empty> {
	...
	Logger.log("addToForgeOS", request.selectedText, filePath, request.language)
