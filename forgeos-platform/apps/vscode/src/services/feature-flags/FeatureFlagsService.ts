import { clearOnboardingModelsCache, getForgeOSOnboardingModels } from "@/core/controller/models/getForgeOSOnboardingModels"
import type { OnboardingModel } from "@/shared/proto/forgeos/state"
...
export class FeatureFlagsService {
	...
	public async poll(userId: string | null): Promise<void> {
		...
		getForgeOSOnboardingModels() // Refresh onboarding models cache if relevant flag changed
	}
